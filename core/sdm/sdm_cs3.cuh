...
struct SDM_CS3// : SDM_BASE<cell_type, index_type, summation_type>
{
public:
    uint K;
    uint L;
    ...
    SDM_CS3(uint K, uint L, uint M, uint N, uint block_count, uint threads_per_block, index_type* mask_indices = NULL);
    ~SDM_CS3();
...
template<typename cell_type, typename index_type, typename summation_type, typename value_type>
SDM_CS3<cell_type, index_type, summation_type, value_type>::SDM_CS3(uint K, uint L, uint M, uint N, uint block_count, uint threads_per_block, index_type* mask_indices)
{
    this->K = K;
    this->L = L;
    this->M = M;
...
template<typename cell_type, typename index_type, typename summation_type, typename value_type>
SDM_CS3<cell_type, index_type, summation_type, value_type>::~SDM_CS3()
{
    cuda_free(cells);
    cuda_free(indices);
    cuda_free(bits);
...
template<typename cell_type, typename index_type, typename summation_type, typename value_type>
double* SDM_CS3<cell_type, index_type, summation_type, value_type>::read(const bool* address)
{
    bool* cuda_address;
...
template<typename cell_type, typename index_type, typename summation_type, typename value_type>
int SDM_CS3<cell_type, index_type, summation_type, value_type>::write(const value_type *value)
{
    return this->write(value, value);
}

template<typename cell_type, typename index_type, typename summation_type, typename value_type>
int SDM_CS3<cell_type, index_type, summation_type, value_type>::write(const value_type *value, const bool *address)
{
    return this->write(value, address, 1.0);
}

template<typename cell_type, typename index_type, typename summation_type, typename value_type>
int SDM_CS3<cell_type, index_type, summation_type, value_type>::write(const value_type *value, const bool *address, double mult)
{
...
template<typename cell_type, typename index_type, typename summation_type, typename value_type>
cell_type SDM_CS3<cell_type, index_type, summation_type, value_type>::get_min_activations()
{
    cell_type min = 0;
...
template<typename cell_type, typename index_type, typename summation_type, typename value_type>
cell_type SDM_CS3<cell_type, index_type, summation_type, value_type>::get_max_activations()
{
    cell_type max = 0;
...
template<typename cell_type, typename index_type, typename summation_type, typename value_type>
long SDM_CS3<cell_type, index_type, summation_type, value_type>::get_activations_num()
{
    long activations = 0;
...
template<typename cell_type, typename index_type, typename summation_type, typename value_type>
void SDM_CS3<cell_type, index_type, summation_type, value_type>::print_state()
{
    cell_type* cell = (cell_type*)malloc((M + 1) * sizeof(cell_type));
